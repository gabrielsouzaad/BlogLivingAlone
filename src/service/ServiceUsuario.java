...
public class ServiceUsuario implements IUsuarioService {
    ...
    private void inicializarPermissoes() {
        Permissao admin = new Permissao("P001", "ADMIN", "Administrador do blog", true, true, true, true,
                java.time.LocalDateTime.now());
        Permissao autor = new Permissao("P002", "AUTOR", "Pode criar e editar posts", true, true, false, false,
                java.time.LocalDateTime.now());
        Permissao leitor = new Permissao("P003", "LEITOR", "Pode apenas ler e comentar", false, false, false, false,
                java.time.LocalDateTime.now());
