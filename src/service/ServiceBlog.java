...
public class ServiceBlog implements IBlogService {
    ...
    public void avaliarPostagens(String tituloPost, int nota, String comentarioAvaliacao, Usuario usuario) {
        Post postagem = lista.buscarPorTitulo(tituloPost);
        if (postagem == null)
    ...
    public Post buscarPostagensPorTitulo(String titulo) {
    ...
    public void desfazerUltimaPostagem() {
    ...
    public String listarPostagensPorAutor(String autor) {
        return lista.listarPorAutorComoTexto(autor);
    }

    public String listarPostagensPorCategoria(String categoria) {
    ...
    private void inicializarPostsDefault() {
        ...
        Comentario c1 = new Comentario("C001", "Adorei a receita 2! Funciona bem para minha rotina.", "leitor1",
                LocalDateTime.now(), p1.getTitulo(), 12, 0, true);
        ...
        Post p2 = new Post("Economizando morando sozinho", "Como reduzir despesas fixas e variáveis em 6 passos",
                "admin", "Finanças");
        Comentario c2 = new Comentario("C002", "Ótimas dicas, já comecei a aplicar.", "leitor1", LocalDateTime.now(),
                p2.getTitulo(), 7, 0, true);
        AvaliacaoPost a2 = new AvaliacaoPost("A002", p2.getTitulo(), "autor1", 4, "Conselhos práticos",
                LocalDateTime.now());
        ...
        Post p3 = new Post("Rotina de limpeza rápida", "Checklist semanal para manter a casa limpa em 30 minutos",
                "autor1", "Limpeza");
        Comentario c3 = new Comentario("C003", "Ótimas ideias, principalmente o item 4.", "admin", LocalDateTime.now(),
                p3.getTitulo(), 3, 0, true);
        AvaliacaoPost a3 = new AvaliacaoPost("A003", p3.getTitulo(), "leitor1", 5, "Muito prático",
                LocalDateTime.now());
